-- Gnosis v4.50 last changed 2015-06-25T11:07:14Z
-- Locale.lua last changed 2015-06-25T11:07:14Z
...
Gnosis.L["OptNameFormatStringDesc"] = [=[이름 표시 구문 입력 방법
...
Gnosis.L["OptOutputStringDesc"] = [=[전투 문자 출력 표시 구문 입력 방법
...
Gnosis.L["OptTimeFormatStringDesc"] = [=[시간 표시 구문 입력 방법
...
초를 위해 s, 60초 보다 긴 분 시간 표시를 위해 m을 추가하고 1초 미만 남았을 때만 정확한 표시를 위해 (r<0a>)를 입력하세요
예. r<1m> 또는 p<2s>
