...
L["None"] = "없음"
L["Normal"] = "보통"
L["Out of range section"] = "사정 거리 밖 섹션"
L["Over limit display"] = "표시 제한 초과"
L["Over limit text"] = "초과 제한 문자"
L["Play a sound when entering this range"] = "이 범위에 들어올때 경고음을 재생합니다."
L["Range limit"] = "거리 제한"
...
L["Show max-min instead of min-max"] = "(최소-최대)대신 (최대-최소)로 보기" -- Needs review
...
L["The text to display for this section"] = [=[문자를 이 부분에 표시하려면
(%d, %d는 분, 최대 범위)]=]
L["The text to display when you are further than range limit"] = [=[문자가 제한 범위 이상에 있으면 표시
(%d는 최소 범위 값)]=]
L["The thickness of the border"] = "테두리 두께"
L["Thick"] = "굵게"
L["Tile Background"] = "타일 배경"
L["Tile the background texture"] = "타일 배경 무늬"
L["Toggle sound"] = "효과음 전환"
...
L["Reverse"] = "Обратить"
L["Short range section"] = "Не далеко"
...
L["The size used to tile the background texture"] = "Размер мозайки используемой в фоновой текстуре"
L["The text to display for this section"] = [=[Текст, отображаемый для этого блока
(%d, %d  - минимум и максимум дистанции)]=]
L["The text to display when you are further than range limit"] = [=[Текст, отображаемый если вы дальше нужной дистанции
(%d - минимум дистанции)]=]
...
L["Use warning sound for enemy targets only"] = "Использовать звук только для цели врага"
