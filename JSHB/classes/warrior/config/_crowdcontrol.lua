--
-- JSHB Warrior Options - crowd control panel
--
			...
			maintab = {
				...
				args = {
					...
					hamstring = {
						type = "toggle",
						order = 6,
						name = function(info) return (GetSpellInfo(1715)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					intimidatingshout = {
						type = "toggle",
						order = 7,
						name = function(info) return (GetSpellInfo(5246)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					piercinghowl = {
						type = "toggle",
						order = 8,
						name = function(info) return (GetSpellInfo(12323)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					thunderclap = {
						type = "toggle",
						order = 9,
						name = function(info) return (GetSpellInfo(6343)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					shockewave = {
						type = "toggle",
						order = 10,
						name = function(info) return (GetSpellInfo(132168)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					stormbolt = {
						type = "toggle",
						order = 11,
						name = function(info) return (GetSpellInfo(132169)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
