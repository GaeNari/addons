--
--	JSHB Death Knight Options - crowd control panel
--
			...
			maintab = {
				...
				args = {
					...
					asphyxiate = {
						type = "toggle",
						order = 6,
						name = function(info) return (GetSpellInfo(108194)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					chainsofice = {
						type = "toggle",
						order = 7,
						name = function(info) return (GetSpellInfo(45524)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					chilblains = {
						type = "toggle",
						order = 8,
						name = function(info) return (GetSpellInfo(50041)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					controlundead = {
						type = "toggle",
						order = 8,
						name = function(info) return (GetSpellInfo(111673)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					glyphofdnd = {
						type = "toggle",
						order = 9,
						name = function(info) return (GetSpellInfo(58629)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					remorselesswinter = {
						type = "toggle",
						order = 10,
						name = function(info) return (GetSpellInfo(108200)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
