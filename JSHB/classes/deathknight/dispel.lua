--
-- JSHB Death Knight - dispel module
--

if (select(2, UnitClass("player")) ~= "DEATHKNIGHT") then return end

local dispelTexture = "Interface\\Icons\\SPELL_DeathKnight_IceTouch" -- Icy Touch
local DISPEL_UPDATEINTERVAL = 0.1

function JSHB.SetupDispelModule(lockName)
	if (JSHB.IsGlyphActive(58631) == false) then return end -- make sure the player has Glyph of Icy Touch active.
