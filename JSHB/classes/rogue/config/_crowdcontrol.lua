--
--	JSHB Rogue Options - crowd control panel
--
			...
			maintab = {
				...
				args = {
					...
					blind = {
						type = "toggle",
						order = 6,
						name = function(info) return (GetSpellInfo(2094)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					cheapshot = {
						type = "toggle",
						order = 7,
						name = function(info) return (GetSpellInfo(1833)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					cripplingpoison = {
						type = "toggle",
						order = 8,
						name = function(info) return (GetSpellInfo(3409)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					debilitatingpoison = {
						type = "toggle",
						order = 9,
						name = function(info) return (GetSpellInfo(115196) .. " (" .. GetSpellInfo(3408) .. " " .. L["Shiv"] .. ")") end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
					...
					sap = {
						type = "toggle",
						order = 10,
						name = function(info) return (GetSpellInfo(6770)) end,
						width = "double",
						disabled = function(info) return (not DB.crowdcontrol.enabled) end,
						get = function(info) return DB.crowdcontrol[info[#info] ] end,
						set = function(info, value) JSHB.Options:CollapseAll(); DB.crowdcontrol[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupCrowdControlModule) end,
