...
function JSHB.SetupResourceBarModule()
	...
	if (GetSpecialization() == 1) then -- Brewmaster
		numBars = UnitPowerMax("player", SPELL_POWER_CHI) -- Chi
		checkStacksFunction = function(self) return(UnitPower("player", SPELL_POWER_CHI) or 0) end -- Chi
		checkFunction = Check_FlashAtMax
	elseif (GetSpecialization() == 2) then -- Mistweaver
		numBars = UnitPowerMax("player", SPELL_POWER_CHI) -- Chi
		checkStacksFunction = function(self) return(UnitPower("player", SPELL_POWER_CHI) or 0) end -- Chi
		checkFunction = Check_FlashAtMax
	elseif (GetSpecialization() == 3) then -- Windwalker
		numBars = UnitPowerMax("player", SPELL_POWER_CHI) -- Chi
		checkStacksFunction = function(self) return(UnitPower("player", SPELL_POWER_CHI) or 0) end -- Chi
		checkFunction = Check_FlashAtMax
	else
