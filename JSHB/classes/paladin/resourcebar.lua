--
-- JSHB Paladin - resource bar module
--
...
function JSHB.SetupResourceBarModule()
	...
	numBars = 5 -- Holy Power
	checkStacksFunction = function(self) return(UnitPower("player", SPELL_POWER_HOLY_POWER) or 0) end -- Holy Power
