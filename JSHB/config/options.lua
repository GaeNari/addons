...
function JSHB.Options:SetupOptions()
	...
	t.args.interrupts		= JSHB.Options:Panel_Interrupts(3)
	t.args.healthbar		= JSHB.Options:Panel_HealthBar(4)
	t.args.targetbar		= JSHB.Options:Panel_TargetBar(5)
	...
	if (playerClass == "DEATHKNIGHT") then
		t.args.resourcebar		= JSHB.Options:Panel_ResourceBar(10)
		t.args.dispel				= JSHB.Options:Panel_Dispel(11)
		t.args.crowdcontrol	= JSHB.Options:Panel_CrowdControl(12)
	...
	elseif (playerClass == "HUNTER") then
		...
		t.args.dispel				= JSHB.Options:Panel_Dispel(11)
		t.args.crowdcontrol	= JSHB.Options:Panel_CrowdControl(12)
		t.args.aspectindicator	= JSHB.Options:Panel_AspectIndicator(13)
		t.args.masterscall		= JSHB.Options:Panel_MastersCall(14)
		t.args.misdirection		= JSHB.Options:Panel_Misdirection(15)
		t.args.bindingshot		= JSHB.Options:Panel_BindingShot(16)
		t.args.snipertraining	= JSHB.Options:Panel_SniperTrainingIndicator(17)
	...
	elseif (playerClass == "MONK") then
		t.args.resourcebar		= JSHB.Options:Panel_ResourceBar(10)
		t.args.crowdcontrol	= JSHB.Options:Panel_CrowdControl(11)
	...
	elseif (playerClass == "ROGUE") then
		...
		t.args.dispel				= JSHB.Options:Panel_Dispel(11)
		t.args.crowdcontrol	= JSHB.Options:Panel_CrowdControl(12)
		t.args.tricksofthetrade= JSHB.Options:Panel_TricksOfTheTrade(13)
		t.args.poisonindicator	= JSHB.Options:Panel_PoisonIndicator(14)
...
do
	...
	button:SetScript("OnEnter",
		function(self)
			...
			GameTooltip:SetText(JSHB.L["JSHB"].." " .. L["Class Mods"] .. " " ..JSHB.myVersion, NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b)
			GameTooltip:AddLine(" ")
